...
@rem ##########################################################################
@rem
@rem  web-app startup script for Windows
@rem
@rem ##########################################################################
...
set CLASSPATH=%APP_HOME%\lib\web-app.jar;%APP_HOME%\lib\kotlin-stdlib-2.4.10.jar;%APP_HOME%\lib\annotations-13.0.jar


@rem Execute web-app
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %WEB_APP_OPTS%  -classpath "%CLASSPATH%" com.jamal.web.MainKt %*
